  ...
  const scenarios = [
    {
      ...
      before: {
        // GoPro still on +02:00: Seoul 09:07 local = 02:07 Amsterdam → day 0, before Amsterdam
        clips: [
          { day: 0, time: '14:12', tz: '[+02:00]',    correct: true,  file: 'amsterdam_day1.MP4', color: 'blue'  },
          { day: 0, time: '02:07', tz: '[+02:00  ✗]', correct: false, file: 'seoul_day2.MP4',     color: 'green' },
        ],
        caption: 'Seoul Day 2 reads as 02:07 — before Amsterdam Day 1 in your timeline',
      },
      after: {
        // Corrected: Seoul is truly day 1 (next day), 09:07 +09:00
        clips: [
          { day: 0, time: '14:12', tz: '[+02:00]', correct: true, file: 'amsterdam_day1.MP4', color: 'blue'  },
