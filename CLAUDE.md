...
- WEB — after every change to files under web/:
  ...
  - this builds the site, starts a preview server, captures hero/problem/features/how-it-works sections plus a full-page shot, saves PNGs to web/screenshots/ with a timestamp prefix
