...
- (2026-03-01) **Pipeline internal migration** — four ordered specs, each enabling the next. Steps 1-2 done. Step 3 is scripts-only; step 4 touches both scripts and macOS app:
