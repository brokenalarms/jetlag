...
- (2026-02-24) **Dry-run diff table** — see `todos/dry-run-diff-table.md` for full spec. PR 1 complete (scripts `@@` output). PR 2 complete (macOS DiffTableView, `@@` parsing, PATH fix, step validation).
